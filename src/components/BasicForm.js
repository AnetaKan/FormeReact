    ...
    <form onSubmit={submitHandler}>
      <div className='control-group'>
        <div className={firstNameClasses}>
         ...
         {firstNameHasError && <p className="error-text">Molim Vas, unesite ime</p> }
        </div>
        ...
        <div className={lastNameClasses}>
          ...
          {lastNameHasError && <p className="error-text">Molim Vas, unesite prezime</p> }
      ...
      <div className={emailClasses}>
        ...
        {emailHasError && <p className="error-text">Molim Vas, unesite validni email</p> }
